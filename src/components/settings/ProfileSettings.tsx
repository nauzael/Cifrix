      ...
      <section>
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 mb-8">
          ...
          <div className="text-center sm:text-left">
            ...
            <span className={`inline-block mt-2 px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wide ${
              profile?.role === 'SUPER_ADMIN' ? 'bg-blue-100 text-blue-700' : 'bg-slate-100 text-slate-600'
            }`}>
