        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-card p-6 rounded-2xl shadow-sm border border-border">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        onClick={async () => {
                            if (window.confirm('¿Está seguro de limpiar todos los datos de exógenos? Esta acción no se puede deshacer y borrará también las validaciones.') && profile?.organizationId) {
